...
void replay_gmn_grinchtest(UInt_t runnum=11494, Long_t nevents=-1, Long_t firstevent=0, const char *fname_prefix="e1209019", UInt_t firstsegment=0, UInt_t maxsegments=1, Int_t pedestalmode=0)
{
  ...
  TString outfilename;
  outfilename.Form( "%s/gmngrinchtest_%d_stream%d_seg%d_%d.root", prefix.Data(), runnum,
  ...
  TString odef_filename = "replay_gmn_grinchtest.odef";
...
int main(int argc, char *argv[])
{
  ...
  replay_gmn_grinchtest(runnum, nevents, firstevent, 
