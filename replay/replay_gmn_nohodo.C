...
void replay_gmn_nohodo(UInt_t runnum=10491, Long_t nevents=-1, Long_t firstevent=0, const char *fname_prefix="e1209019", UInt_t firstsegment=0, UInt_t maxsegments=1, Int_t pedestalmode=0)
{
  ...
  TString odef_filename = "replay_gmn_nohodo.odef";
...
int main(int argc, char *argv[])
{
  ...
  replay_gmn_nohodo(runnum, nevents, firstevent, 
