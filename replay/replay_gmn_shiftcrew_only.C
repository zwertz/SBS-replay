...
void replay_gmn_shiftcrew_only(UInt_t runnum=10491, Long_t nevents=-1, Long_t firstevent=0, const char *fname_prefix="e1209019", UInt_t firstsegment=0, UInt_t maxsegments=1, Int_t pedestalmode=0)
{
  ...
  TString outfilename;
  outfilename.Form( "%s/gmn_replayed_%d_stream%d_seg%d_%d_firstevent%d_nevent%d.root", prefix.Data(), runnum,
  ...
  analyzer->SetSummaryFile(Form("%s/replay_gmn_%d_stream%d_seg%d_%d_firstevent%d_nevent%d.log", prefix.Data(), runnum, 
				stream, firstsegment, lastsegment, firstevent, nevents ));
