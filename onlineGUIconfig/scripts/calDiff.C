void calDiff(){
  ...
  TH1D *h1_calDiff = new TH1D("h1_calDiff","HCal/BBCalLo Difference; ns", 1000, -50, 950);
  ...
  for(Long64_t nevent=0; nevent<nevents; nevent++){
    ...
    for(Int_t ihit=0; ihit<Ndata_bb_tdctrig_tdcelemID; ihit++){
      ...
      if(bb_tdctrig_tdcelemID[ihit]==2) bblo_time=bb_tdctrig_tdc[ihit];
    }
    h1_calDiff->Fill(hcal_time-bblo_time);
  }
