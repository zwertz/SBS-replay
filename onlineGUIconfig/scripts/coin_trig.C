void coin_trig(){
  ...
  cout << "Processing coin_trig.." << endl;
  ...
  TH1D *h1_coin_trig = new TH1D("h1_coin_trig","Coincidence Trigger TDC Time; ns", 500, 499, 999);
  ...
  for(Long64_t nevent=0; nevent<nevents; nevent++){
    ...
    h1_coin_trig->Fill(coin_time);
  }
  
  h1_coin_trig->SetStats(0);
  h1_coin_trig->Draw();
