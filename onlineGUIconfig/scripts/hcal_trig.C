void hcal_trig(){
  ...
  cout << "Processing hcal_trig.." << endl;
  ...
  TH1D *h1_hcal_trig = new TH1D("h1_hcal_trig","HCal Trigger TDC Time; ns", 500, 499, 999);
