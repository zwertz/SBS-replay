void coinBBDiff_slow(){

  cout << "Processing coinBBDiff_slow.." << endl;
  ...
  TH1D *h1_coinBBDiff_slow = new TH1D("h1_coinBBDiff_slow","Coincidence/BBCal Difference; ns", 100, -50, 50);
