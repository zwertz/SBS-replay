void GEM_hit_map(int layer){
  ...
  t->Draw( Form("bb.gem.hit.xglobal:bb.gem.hit.yglobal>>hit2d_layer%d",layer),Form("bb.gem.hit.layer == %d&& bb.gem.track.ntrack==1&&bb.gem.track.nhits[bb.gem.hit.trackindex]>=4",layer),"colz" );
